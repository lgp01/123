...
<script type="text/javascript">
	$(function(){
		$("#username").change(function(){
			...
			$.get("username.do","username="+this.value,function(obj){
				if(obj.code==0){
		...
		$("#email").change(function(){
			//使用ajax 做username 的异步验证 checkUsername?username=xxxx
			$.get("useremail.do","email="+this.value,function(data){
				if(data==1){
	...
	<div class="regist">
		<div class="regist_center">
			<div class="regist_top">
				...
				<div class="right fr">
					<a href="index.jsp" target="_black">签到</a>
				</div>
				<div class="clear"></div>
				<div class="xian center"></div>
			</div>
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="usersave.do" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<p class="text-danger"><span class="help-block " id="emailMsg"></span></p>
						</div>
					</div>
					<div class="form-group">
